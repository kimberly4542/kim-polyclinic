...
class PatientProfileMedicineController extends Controller
{
    public function clinic_medicines () {
		...
		return view ('secretary_portal.profile.medicine_clinic', compact('clinicQuery'));
	}
	...
	public function patient_profile_medicine($clinic_id)
	{
		...
		return view ('secretary_portal.profile.patient_profile_medicine', compact('medicineQuery', 'clinic_id'));
	}
