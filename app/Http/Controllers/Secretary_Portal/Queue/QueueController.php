...
namespace App\Http\Controllers\Secretary_Portal\Queue;
...
class QueueController extends Controller
{
		...
		return view ('secretary_portal.queue.clinic_table', compact('clinicQuery'));
	}
	...
	public function queue_patient ($clinic_id) {
		...
		$patient_new_sched = DB::table('patient_schedule')
								...
								->get();
		return view ('secretary_portal.queue.queue_profile',compact('get','get1', 'clinic_id','get_med','patient_new_sched', 'get2', 'get3'));
	}
	...
	public function add_new_queue($clinic_id, $patient_id, $fname, $lname)
	{
		...
		return redirect('sec_queue/queue_patient/'.$clinic_id);
	}
	...
	public function add_queue(Request $request)
	{
	   ...
	   $query = Patient::create([
		...
		return redirect('/sec_queue/clinic_table');
	}
