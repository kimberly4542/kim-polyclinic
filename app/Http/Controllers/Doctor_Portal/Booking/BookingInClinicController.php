...
namespace App\Http\Controllers\Doctor_Portal\Booking;
...
class BookingInClinicController extends Controller
{
	...
	public function booking_in_clinic()
	{
		...
		return view ('doctor_portal.booking.booking_clinic_table', compact('clinicQuery','clinicQuery1', 'patient_sched', 'clinicQuery2', 'clinicQuery4'));
	}
	...
	public function booking_patient()
	{
		...
		// }
			return redirect('/booking/booking_clinic_table');
	}
