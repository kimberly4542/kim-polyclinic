...
class PatientProfileController extends Controller
{
	public function patient_clinic () {
		...
		return view ('doctor_portal.profile.patient_clinic', compact('clinicQuery'));
	}
	...
	public function patient_profile($clinic_id)
	{
		...
		return view ('doctor_portal.profile.patient_profile', compact('query', 'clinic_id', 'guardianQuery'));
	}
	...
	public function update_patient_basic_info (Request $request) {
		...
		return redirect('profile/patient_profile/'.$clinic_id)->with('successMessage', 'successfully updated patient basic information');
	} 
	...
	public function update_guardian_info (Request $request) {
		...
		return redirect('profile/patient_profile/'.$clinic_id)->with('successMessage', 'successfully added guardian information');
	}
}
