...
class ScheduleAllClinicController extends Controller
{
    ...
    {
        return view ('doctor_portal.schedule.schedule_patient_all_clinic');
    }
    ...
    public function schedule_clinic_table()
    {
        ...
        return view('doctor_portal.schedule.schedule_clinic_table', compact('clinicQuery','patient_sched'));
    }
