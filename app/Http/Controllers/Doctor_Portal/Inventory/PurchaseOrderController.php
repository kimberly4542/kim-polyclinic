...
class PurchaseOrderController extends Controller
{
	public function purchase_order ($clinic_id) {
		return view ('doctor_portal.inventory.purchase_order', compact('clinic_id'));
	}
	...
	public function print_purchase_order (Request $request, $clinic_id) {
		...
		return view ('doctor_portal.inventory.print_purchase_order', compact('clinicQuery', 'query'));
	}
}
