...
class InventoryOtherClinicController extends Controller
{
    ...
    public function inventory_other_clinic () {
    	return view ('doctor_portal.inventory.inventory_other_clinic');
    }
}
