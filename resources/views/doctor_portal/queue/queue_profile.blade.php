...
@section('body')
				...
				<div class="row clearfix">
					<div class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
						 <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
						 	@if(Auth::guard('queue_1st_priority')->check())
						 		@if(Auth::guard('queue_1st_priority_dragDrop')->check())
									<div class="card">
										<div class="header">
											 <h5>1st Priority</h5>
										</div>
							...
							@if(Auth::guard('queue_2nd_priority')->check())
						 		@if(Auth::guard('queue_2nd_priority_dragDrop')->check())
									<div class="card">
										<div class="header">
											 <h5>2nd Priority</h5>
										</div>
							...
							@if(Auth::guard('queue_1st_priority')->check())
						 		@if(Auth::guard('queue_1st_priority_basicTable')->check())
									<div class="card">
										<div class="header">
											 <h5>1st Priority</h5>
										</div>
							...
							@if(Auth::guard('queue_2nd_priority')->check())
						 		@if(Auth::guard('queue_2nd_priority_basicTable')->check())
									<div class="card">
										<div class="header">
											 <h5>2nd Priority</h5>
										</div>
												...
												<table class="table dataTable js-basic-example">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<a href="/queue/add_new_queue_olbook/{{$clinic_id}}/{{$data->book_online_id}}/{{ $data->book_fname }}/{{ $data->book_lname }}">
																	<button type="button" 
																			class="btn btn-info btn-xs waves-effect">1ST
																		</button>
																</a>|<a href="/queue/add_new_queue_2nd_olbook/{{$clinic_id}}/{{$data->book_online_id}}/{{ $data->book_fname }}/{{ $data->book_lname }}">
												...
												<table class="table dataTable js-basic-example">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<a href="/queue/add_new_queue/{{$clinic_id}}/{{$data->patient_id}}/{{ $data->fname }}/{{ $data->lname }}">
																	<button type="button"
																			class="btn btn-info btn-xs waves-effect">1ST
																	</button>
																</a>|
																<a href="/queue/add_new_queue_2nd/{{$clinic_id}}/{{$data->patient_id}}/{{ $data->fname }}/{{ $data->lname }}">
																	<button type="button" class="btn btn-danger btn-xs waves-effect">2ND
																	</button>
																</a>
															</td>
	...
	<!-- Consultation MODAL -->
	<form action="/queue/addConsultation" method="POST">
	{{ csrf_field() }}
												    ...
												    <table class="table table-bordered" id="crud_table">
													     ...
													     <tbody class="addMedicine">
													     	<tr>
																...
																<input type="text" name="clinic_idd" value="{{ $clinic_id}}">
