...
@section('body')
	<section class="content" id="app">
		<div class="container-fluid">
					...
					<div class="body">
						<div class="row clearfix">
							...
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
								@if(Auth::guard('profile_patient_patientList_basicTable')->check())
									<div class="card">
										<div class="body">
								...
								@if(Auth::guard('profile_patient_patientList_contextual')->check())
									<div class="card">
										<div class="body">
											<div class="list-group" id="redemption">
			...
			<form action="{{ url('profile/update_guardian_info') }}" method="POST">
				@csrf
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="row">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px;">
											<input type="text" style="display: none;" name="guardian_no" readonly>
											<input type="text" style="display: none;" name="clinic_id" value="{{ $clinic_id }}" readonly>
			...
			<form action="{{ url('profile/update_patient_basic_info') }}" method="POST" enctype="multipart/form-data">
				{{ csrf_field() }}
			...
			<script>
				$(document).ready(function() {
					$("#redemption button").on("click", function (e) {
						...
						buttonPatientMedicalHistory_tag += '<a href="{{ url('profile/patient_profile_history') }}/';
						...
						buttonPatientBillingHistory_tag += '<a href="{{ url('profile/patient_profile_billing_history') }}/';
						...
						buttonPatientCertificate_tag += '<a href="{{ url('profile/patient_profile_certificate') }}/';
