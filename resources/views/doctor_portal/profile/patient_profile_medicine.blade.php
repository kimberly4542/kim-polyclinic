							...
							<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12" style="padding: ">
								<div class="card">
									<div class="body" style="padding: 10px;">
										<a href="{{ url('profile/clinic_medicines') }}" 
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body" >
							<form action="{{ url('profile/med_info/update') }}" method="POST" enctype="multipart/form-data">
								@csrf
								{{ method_field('put') }}
			...
			<div class="modal fade" id="addMedicine" tabindex="-1" role="dialog">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body" >
							<form action="{{ url('profile/med_info/store') }}" method="POST" enctype="multipart/form-data">
								@csrf
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top: 10px; margin-bottom: 10px;">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
