		...
		<div class="container-fluid">
										...
										<div class="card">
											<div class="body">
												<div class="list-group">
													<a href="{{ url('inventory/item') }}/{{$clinic_id}}" class="list-group-item active">Items</a>
															...
															<div class="table-responsive">
																...
																<tbody>
																	@if(!$stockOutQuery)
																		<td>No Medicine Found</td>
																	@else
																		@foreach($stockOutQuery as $data)
																			@foreach($data->getStockOut as $stockout)	
																				<tr>
																					<td>{{ $data->generic_name }}</td>
																					...
																					{{-- <td>{{ $stockOutData->quantity }}</td>
																					<td>{{ $stockOutData->dose }}</td>
																					<td>{{ $stockOutData->frequency }}</td> --}}
																					{{-- <td>
																						<button class="btn btn-primary waves effect"
																							data-med_id="{{ $data->med_id }}"
																							data-generic_name="{{ $data->generic_name }}"
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body" >
							<form action="{{ url('inventory/addStock') }}" method="POST" enctype="multipart/form-data">
								@csrf
			...
			<div class="modal fade" id="viewModal" tabindex="-1" role="dialog">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title" id="largeModalLabel">Inventory Information</h4>
						</div>
						<div class="modal-body">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="card">
