			...
			<div class="row clearfix">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<div class="row clearfix">
								@if(Auth::guard('schedule_clinic')->check())
									@if(Auth::guard('schedule_clinic_basicTable')->check())
									...
									@endif
								@endif
								@if(Auth::guard('schedule_patient')->check())
									@if(Auth::guard('schedule_patient_basicTable')->check())
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
											<div class="table-responsive">
												<table class="table table-hover">
													<thead>
								...
								@endif
								@if(Auth::guard('schedule_clinic')->check())
									@if(Auth::guard('schedule_clinic_hoverTable')->check())
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
											<div class="table-responsive">
								...
								@endif
								@if(Auth::guard('schedule_patient')->check())
									@if(Auth::guard('schedule_patient_hoverTable')->check())
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 ">
											<div class="table-responsive">
												<table class="table table-hover js-basic-example dataTable">
													<thead>
