...
<head>
    ...
    <!-- Google Fonts -->
    <link rel="stylesheet" href="{{ URL::asset('AdminSB/css/fonts.css') }}">
    <link rel="stylesheet" href="{{ URL::asset('AdminSB/css/fonts2.css') }}">

    <!-- Bootstrap Core Css -->
    <link rel="stylesheet" href="{{ URL::asset('AdminSb/plugins/bootstrap/css/bootstrap.css') }}">

    <!-- Waves Effect Css -->
    <link rel="stylesheet" href="{{ URL::asset('AdminSb/plugins/node-waves/waves.css') }}">

    <!-- Animation Css -->
    <link rel="stylesheet" href="{{ URL::asset('AdminSb/plugins/animate-css/animate.css') }}">

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ URL::asset('AdminSb/css/style.css') }}">

    <!-- AdminBSB Themes. You can choose a theme from css/themes instead of get all themes -->
    <link rel="stylesheet" href="{{ URL::asset('AdminSb/css/themes/all-themes.css') }}">
</head>
