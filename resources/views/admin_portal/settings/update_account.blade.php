				...
				<div class="card">
					<div class="header">
						<h2>
							...
							<small>Update Admin Account</small>
						</h2>
					</div>
					...
					<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
						<form action="{{ url('settings/update_admin_account') }}" method="POST">
							{{ method_field('put') }}
							{{ csrf_field() }}
							@csrf
							<div class="form-group form-float">
								<br>
								<div class="form-line">
									<input type="text" id="validateLetters" value="{{ $admin_fname }}" class="form-control" name="firstname">
									<label class="form-label">First Name:</label>
								</div><br>
								<div class="form-line">
									<input type="text" id="validateLetters2"  value="{{ $admin_lname }}"class="form-control" name="lastname">
									<label class="form-label">Last Name:</label>
								</div> <br>
								<div class="form-line">
									<input type="text" class="form-control"  value="{{ $admin_username }}" name="username">
