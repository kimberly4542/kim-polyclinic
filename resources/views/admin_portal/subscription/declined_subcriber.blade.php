					...
					<div class="card">
						<div class="header">
							<h2>
								...
								<small>Subscribers that are declined for some reasons</small>
							</h2>
						</div>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title" id="defaultModalLabel">Activate Subscriber</h4>
					</div>
					<form action="{{ url('subscription/declined_subscriber/verify') }}" method="POST">
						@csrf
						{{ method_field('put') }}
