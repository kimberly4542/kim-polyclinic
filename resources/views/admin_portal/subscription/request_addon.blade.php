			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						<div class="header">
							<h2>
								Subscription Request Add-ons
								<small>Subscription request add-on</small>
							</h2>
						</div>
		...
		<div class="modal fade" id="declineModal" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="{{ url('subscription/request_addon_table/decline') }}" method="POST">
						@csrf
						{{ method_field('put') }}
		...
		<div class="modal fade" id="verifyModal" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<form action="{{ url('subscription/request_addon_table/verify') }}" method="POST">
						@csrf
						{{ method_field('put') }}
						<div class="modal-body">
					...
					<div class="modal-body">
						...
						<div class="col-lg-12 col-md-12 col-sm-12  col-xs-12">
							<div class="col-lg-6 col-md-6 col-sm-6  col-xs-6">
								...
								{{-- <br>
								<a href="{{ url('module_controller/request_feature') }}" type="button" class="btn bg-deep-orange waves-effect">Go to Module Controller</a> --}}
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6  col-xs-6">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<h5>Total Payment:</h5>
