							...
							<div class="row clearfix">
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" id="div-list-group-item-heading" style="padding-bottom: 20px;">
										<h4 class="list-group-item-heading">nebrilkurtkevin5@gmail.com</h4>
										<div class="btn-group" role="group">
											...
											<ul class="dropdown-menu" >
												<p id="dropdown-content"><b>from:</b> nebrilkurtkevin5@gmail.com</p>
												<p id="dropdown-content"><b>to:</b>  nebrilkurtkevin6@gmail.com</p>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-left: 0px; padding-left: 0px;">
										<div class="pull-left">
											<a href="{{ url('email/subscriber_email') }}" type="button" class="btn btn-primary waves-effect">Reply</a>
											<a href="javascript:history.back()" type="button" class="btn btn-link waves-effect" >Back</a>
										</div>
									</div>
