			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							Active Subscribers
							<small>Active subscribers that are currently subscribing the system</small>
						</h2>
					</div>
						...
						<table class="table table-hover">
							...
							<tbody>
								{{-- <tr>
									...
									<td>Otto</td>
									<td>Orthopaedics</td>
									<td> <button style="visibility: hidden;">center</button> <span class="badge bg-green">static</span></td>
									<td><button class="btn btn-primary waves-effect btn-sm" data-toggle="modal" data-target="#viewInfo">View Info</button>
									<button class="btn btn-danger waves-effect btn-sm" data-toggle="modal" data-target="#deactivateSubscriber">Deactivate</button></td>
								</tr> --}}
									...
									@foreach($mainQuery as $query)
										@foreach($query->subscribers as $data)
											<tr>
												...
												<td>{{ $subscriberQuery->getActiveDuration($data->subscriber_id) }}</td>
												<td><a 
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="defaultModalLabel">Deactivate Subscriber</h4>
				</div>
				<form action="{{ url('account_management/active_subscriber_table/deactivate') }}" method="POST">
					@csrf
					{{ method_field('put') }}
					<div class="modal-body">
						<p>Are you sure you want to deactivate this subscriber? The subscriber will be deactivated.</p>
