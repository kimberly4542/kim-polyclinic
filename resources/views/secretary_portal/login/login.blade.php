...
<head>
	...
	<title>Login - Secretary Portal</title>
	...
	<style type="text/css">
		...
		.login-page {
			background: linear-gradient(to bottom, #ff001a 0%, #ff3348 54%);
			padding-left: 0;
			max-width: 360px;
			max-height: 1080px;
			width: 100%;
...
<body class="login-page" style="height: 700px;">
	<div class="login-box">
		...
		<div class="card">
			<div class="body">
				<form id="sign_in" method="POST" action="{{ url('sec_session/login/store') }}">
					@csrf
...
@section('body')
	<main role="main" class="container">
		...
		<form action="{{ url('laracast2/login/store') }}" method="POST">
			@csrf

			<div class="form-group" >
				<label for="">Email</label>
				<input type="text" class="form-control" id="" aria-describedby="" placeholder="Enter Email" name="email">
			</div>

			<div class="form-group">
				<label for="">Password</label>
				<input type="password" class="form-control" id="" aria-describedby="" placeholder="Enter password" name="password">
			</div>
