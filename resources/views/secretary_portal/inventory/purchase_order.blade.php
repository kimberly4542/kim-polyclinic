							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-sx-12">
									...
									<div class="card">
										<div class="body">
											<div class="list-group">
												<a href="{{ url('sec_inventory/item') }}/{{$clinic_id}}" class="list-group-item">Items</a>
												<a href="{{ url('sec_inventory/purchase_order')}}/{{$clinic_id}}" class="list-group-item active">Purchase Order</a>
								...
								<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
									<div class="card">
										...
										<form action="{{ url('sec_inventory/print_purchase_order') }}/{{ $clinic_id }}" method="POST">
											@csrf
											<div class="body">
