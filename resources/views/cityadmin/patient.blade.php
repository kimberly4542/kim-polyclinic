                ...
                <div class="card col-lg-10">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="form-outline">
                          ...
                          <input type="text" name="mname" id="form3Example2" class="form-control" />
                    ...
                    <div class="row">
                        <div class="col-md-6" style="margin-left:-10px; margin-top:15px">
                            ...
                            <div class="form-outline">
                                ...
                                <input type="date" name="birth_date" class="date-picker form-control">
                          ...
                          <br>
                              <div class="col" style="margin-top: -8px">
                                ...
                                <div class="form-outline" style="margin-top: 25px">
                                  ...
                                  <select class="form-control show-tick" name="civil_status" tabindex="-98">
                                ...
                                <div class="form-outline" style="margin-top: 25px; margin-left: -15px">
                                  <div class="col">
                                    ...
                                    <input type="text" name="contact_no" id="form3Example1" class="form-control" />
                                    </div>  
                                  </div> 
                                </div>
                      ...
                      <div class="col col-lg-12">
                        ...
                        <div class="form-outline">
                          ...
                          <input type="text" name="address1" id="form3Example1" class="form-control" />
                        </div>
                        <br>
                        <div class="form-outline">
